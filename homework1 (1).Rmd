...
Game5Time <- c(Date,starttime,TimeZone)
...
starttime <- ymd_hm("2020,oct.9,21:00",tz="America/New_York")
Timestamp  <- with_tz(starttime,tz="Asia/Taipei") 
# with_tz 轉換時區 某地區的一個時間=另一個地區的何時?前提是電腦已經懂了你輸入的時間 (即前面的lubridate設定)

print(starttime)
print(Timestamp)

save(Timestamp,file="TpeJason")
```
